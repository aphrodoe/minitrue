...
func NewMessageHandler(gossipProtocol *GossipProtocol, hashRingUpdater func(string, bool)) *MessageHandler {
...
func (mh *MessageHandler) HandleMessage(data []byte, conn net.Conn) error {
	...
	case "gossip_sync":
		...
		var req models.GossipSyncRequest
		if err := json.Unmarshal(payloadBytes, &req); err != nil {
			return err
		}

		mh.gossipProtocol.HandleGossipSyncRequest(req)
